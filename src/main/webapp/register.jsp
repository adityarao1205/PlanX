...
<head>
  ...
  <style>
    body {
      background: url('${pageContext.request.contextPath}/assets/images/events/banner2.jpg') no-repeat center center/cover;
      min-height: 100vh;
      display: flex;
      align-items: center;
    ...
    /* ✅ Fixed text color and glow for inputs */
...
<body>
  ...
  <div class="register-card text-center">
    ...
    <p class="text-secondary mb-4">Join PlanX and explore exciting events!</p>
